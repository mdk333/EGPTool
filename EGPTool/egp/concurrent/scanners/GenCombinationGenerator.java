...
//        String[] partition = new String[]{"0,1", "2,3", "4,5", "6,7"};
       ...
       // String[] partition = new String[]{"0,3", "4,7"/*, "8,11", "12,15"*/};
        ...
        StringBuffer combination; String combinations = "";
        while (x.hasMore()) {
            ...
            if (indicesOkFlag) {
                ...
                //so process it
                for (int i = 0; i < indices.length; i++) {
                    combination.append(elements[indices[i]]).append((i < indices.length - 1) ? "," : "");
                }
                combinations = combinations.concat(combination.append(";").toString());
...
//                        ConstraintEvaluator ce = new ConstraintEvaluator(new Lexer(new StringReader(aConstraint)));
//                        String result = "";
//                        try {
...
//        GenCombinationGenerator gc = new GenCombinationGenerator(elements.length, 0);
//        gc.generateAll(elements);
//    }
//    
